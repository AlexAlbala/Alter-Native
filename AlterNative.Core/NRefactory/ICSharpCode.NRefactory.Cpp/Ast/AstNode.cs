...
namespace ICSharpCode.NRefactory.Cpp
{
    public abstract class AstNode : AbstractAnnotatable, PatternMatching.INode
    {
        ...
        // filters all non Cpp nodes (comments, white spaces or pre processor directives)
        public AstNode GetCppNodeBefore(AstNode node)
        {
        ...
        internal string DebugToString()
        {
            ...
            AcceptVisitor(new CppOutputVisitor(w, new CppFormattingOptions()), null);
        ...
        public static class Roles
        {
            ...
            public static readonly Role<Statement> EmbeddedStatement = new Role<Statement>("EmbeddedStatement", Ast.Statement.Null);
            //
            public static readonly Role<CppTokenNode> Keyword = new Role<CppTokenNode>("Keyword", CppTokenNode.Null);
            public static readonly Role<CppTokenNode> InKeyword = new Role<CppTokenNode>("InKeyword", CppTokenNode.Null);

            // some pre defined constants for most used punctuation
            public static readonly Role<CppTokenNode> LPar = new Role<CppTokenNode>("LPar", CppTokenNode.Null);
            public static readonly Role<CppTokenNode> RPar = new Role<CppTokenNode>("RPar", CppTokenNode.Null);
            public static readonly Role<CppTokenNode> LBracket = new Role<CppTokenNode>("LBracket", CppTokenNode.Null);
            public static readonly Role<CppTokenNode> RBracket = new Role<CppTokenNode>("RBracket", CppTokenNode.Null);
            public static readonly Role<CppTokenNode> LBrace = new Role<CppTokenNode>("LBrace", CppTokenNode.Null);
            public static readonly Role<CppTokenNode> RBrace = new Role<CppTokenNode>("RBrace", CppTokenNode.Null);
            public static readonly Role<CppTokenNode> LChevron = new Role<CppTokenNode>("LChevron", CppTokenNode.Null);
            public static readonly Role<CppTokenNode> RChevron = new Role<CppTokenNode>("RChevron", CppTokenNode.Null);
            public static readonly Role<CppTokenNode> Comma = new Role<CppTokenNode>("Comma", CppTokenNode.Null);
            public static readonly Role<CppTokenNode> QuestionMark = new Role<CppTokenNode>("QuestionMark", CppTokenNode.Null);
            public static readonly Role<CppTokenNode> Dot = new Role<CppTokenNode>("Dot", CppTokenNode.Null);
            public static readonly Role<CppTokenNode> Semicolon = new Role<CppTokenNode>("Semicolon", CppTokenNode.Null);
            public static readonly Role<CppTokenNode> Assign = new Role<CppTokenNode>("Assign", CppTokenNode.Null);
            public static readonly Role<CppTokenNode> Colon = new Role<CppTokenNode>("Colon", CppTokenNode.Null);
            public static readonly Role<CppTokenNode> DoubleColon = new Role<CppTokenNode>("DoubleColon", CppTokenNode.Null);
            public static readonly Role<CppTokenNode> StatementTerminator = new Role<CppTokenNode>("StatementTerminator", CppTokenNode.Null);
            ...
            /// Text: &lt;
            /// </summary>
            public static readonly Role<CppTokenNode> XmlOpenTag = new Role<CppTokenNode>("XmlOpenTag", CppTokenNode.Null);
            /// <summary>
            /// Text: &gt;
            /// </summary>
            public static readonly Role<CppTokenNode> XmlCloseTag = new Role<CppTokenNode>("XmlOpenTag", CppTokenNode.Null);
